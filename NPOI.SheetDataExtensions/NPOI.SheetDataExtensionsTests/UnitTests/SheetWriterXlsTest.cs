...
namespace NPOI.SheetDataExtensionsTests.UnitTests
{
    ...
    public class SheetWriterXlsTest : SheetWriterTestBase
    {
        public SheetWriterXlsTest(TestSheetWriterXlsFixture testSheetWriterXlsFixture, ITestOutputHelper outputHelper) : 
            base(testSheetWriterXlsFixture, outputHelper)
        { }
